...
namespace MathNet.Numerics.LinearAlgebra
{
    ...
    public class Matrix : ICloneable
    {
        ...
        public Matrix(double[][] A)
        {
            array = new double[A.Length, A[0].Length];
        ...
        public Matrix(int[,] A)
        {
            array = new double[A.GetLength(0), A.GetLength(1)];
        ...
        /// </summary>
        /// <param name="vals">One-dimensional array of doubles</param>
        public Matrix(double[] vals) : this(vals, 1) { }
        ...
        /// <summary>
        /// Index of row having maximun value of given column.
        /// </summary>
        /// <param name="columnIndex"></param>
        /// <returns></returns>
        public int MaxIndexOfRow(int columnIndex)
        {
            ...
            {
                if (array[j, columnIndex] > max)
                {
                    max = array[j, columnIndex];
                    idx = j;
                }
            }
