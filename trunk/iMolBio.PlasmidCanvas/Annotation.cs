...
namespace iMoBio.PlasmidCanvas
{
    ...
    /// <summary>
    /// Class representation annotation encompassing <code>Feature</code> and 
    /// interact with user.
    /// 
    ...
    public class FeatureUI
    {
        ...
        protected internal readonly Layer Layer;
        ...
        public FeatureUI(ISeqCanvas parent, Layer layer, Feature feature)
        {
            ...
            Canvas.SetZIndex(shape, Layer.ZINDEX_ANNOTATION);
        ...
        public AnnotationShape AnnotationShape
        {
            get
            {
                if (_annotationShape == AnnotationShape.Undefined)
                    return parent.LayerManager[this.Key].AnnotationShape;
                else
